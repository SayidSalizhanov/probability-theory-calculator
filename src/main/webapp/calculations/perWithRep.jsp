...
<div class="container">
    <h2>Перестановка с повторением</h2>

    <form action="/permutationsWithRepetition" method="post">
        <div class="form-group">
            <label for="totalItems">Перечислите количество различных предметов через пробел:</label>
